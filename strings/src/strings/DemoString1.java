...
public class DemoString1 {
    public static void main(String[] args) {
        ...
        System.out.println("str3.indexOf(\"bla\"): " + str3.indexOf("bla")); // falso retorna -1
        ...
        System.out.println("str3.lastIndexOf('t'): " + str3.lastIndexOf('t')); // retorna o indice andando para tras
